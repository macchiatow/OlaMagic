		...
		<div id="list-campaign" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="details" title="${message(code: 'campaign.details.label', default: 'Details')}" />
				...
				<g:each in="${campaignInstanceList}" status="i" var="campaignInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${campaignInstance.id}">${fieldValue(bean: campaignInstance, field: "details")}</g:link></td>
