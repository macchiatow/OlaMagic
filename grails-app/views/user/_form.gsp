...
<div class="fieldcontain ${hasErrors(bean: secUserInstance, field: 'uid', 'error')} required">
	<label for="uid">
		<g:message code="secUser.uid.label" default="Username" />
		<span class="required-indicator">*</span>
	</label>
	<g:textField name="uid" required="" value="${secUserInstance?.uid}"/>
